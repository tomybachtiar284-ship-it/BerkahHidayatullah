export const id = {
  ...
  home: {
    hero: {
      title1: "Bangun Masa Depan",
      title2: "dengan Solusi",
      title3: "Terpercaya",
      desc: 'CV Berkah Hidayatullah hadir sebagai mitra strategis Anda di Gorontalo untuk konstruksi, perdagangan umum, agribisnis, dan, Menjadi pemimpin terpercaya di bidang konstruksi, pengadaan, dan pemeliharaan dengan memberikan solusi yang berkualitas dan berkelanjutan.',
      cta: "Lihat Layanan Kami"
    },
    stats: {
      title: "Mengapa Memilih Kami?",
      subtitle: "Solusi bisnis terintegrasi dan berkualitas tinggi.",
      trusted: "Terpercaya di Gorontalo.",
      items: [
        { title: "Legalitas Terjamin", desc: "Terdaftar resmi di Kemenkumham dengan perizinan lengkap untuk eksekusi proyek aman." },
    ...
    services: {
      ...
      items: [
        { title: "Konstruksi Sipil", desc: "Pembangunan infrastruktur gedung, jalan, dan jembatan berkualitas tinggi." },
        { title: "Perdagangan Umum", desc: "Distribusi material bahan bangunan, farmasi, dan suku cadang industri." },
        { title: "Agribisnis & Jasa", desc: "Budidaya hasil bumi dan penyelenggara event profesional (MICE)." }
      ]
    },
    projects: {
      items: [
        { title: "Pekerjaan Sipil Dasar", desc: "Penyelesaian tahap awal infrastruktur pondasi dan struktur utama bangunan." },
        { title: "Pengadaan Material", desc: "Distribusi bahan baku industri dan konstruksi berskala menengah ke atas." },
        { title: "Perencanaan Kota", desc: "Konsultasi dan eksekusi tata letak komersial untuk efisiensi ruang." }
      ],
      cta: "Detail Proyek"
    },
    coreServices: {
  ...
  profile: {
    title: "Tentang Kami",
    subtitle1: "Integritas & Kualitas",
    subtitle2: "dalam Setiap Proyek.",
    desc1: "Berdiri di Kabupaten Gorontalo, CV Berkah Hidayatullah adalah perusahaan multi-sektor yang bergerak di bidang konstruksi, perdagangan eceran, agribisnis, perikanan, hingga jasa penyelenggara event (MICE). Kami berkomitmen menjadi katalisator pembangunan daerah melalui standar operasional yang profesional dan hasil kerja yang dapat diandalkan.",
    desc2: "Didorong oleh visi untuk menjadi mitra strategis utama bagi pemerintah maupun swasta, kami memadukan tenaga kerja terampil, material berkualitas, dan sistem manajemen yang transparan untuk memastikan setiap proyek selesai tepat waktu dan melebihi ekspektasi klien.",
    vision: {
      title: "Visi Kami",
      desc: "Menjadi pemimpin terpercaya di bidang konstruksi, pengadaan, dan pemeliharaan dengan memberikan solusi yang berkualitas dan berkelanjutan."
    },
    values: {
      title: "Nilai Inti (Core Values)",
      items: [
        { title: "Keandalan (Reliability)", desc: "Menyelesaikan setiap proyek sesuai spesifikasi, anggaran, dan tenggat waktu." },
        { title: "Kualitas (Quality)", desc: "Standar mutu tanpa kompromi dari pemilihan material hingga eksekusi." },
        { title: "Integritas (Integrity)", desc: "Transparansi dan kejujuran dalam setiap aspek bisnis." }
      ]
    },
    legal: {
      title: "Identitas Dokumen Hukum",
      desc: "Perubahan Anggaran Dasar CV Berkah Hidayatullah ini telah resmi diterima dan terdaftar dalam Sistem Administrasi Badan Usaha Kementerian Hukum dan HAM RI melalui Surat Keterangan AHU-0028817-AH.01.16 Tahun 2024 yang diterbitkan pada 11 Juli 2024.",
      labels: {
        akta: "Nomor Akta",
        notaris: "Notaris",
        kedudukan: "Kedudukan"
      ...
      values: {
        akta: "Akta Nomor 24, Tanggal 27 Juni 2024",
        notaris: "Dr. Kaharuddin Kamaru, S.H., M.Kn.",
        kedudukan: "Desa Ombulo, Kecamatan Limboto Barat, Kabupaten Gorontalo."
      }
    },
    management: {
      title: "Kepengurusan & Modal Perseroan",
      desc: "Seiring dengan perkembangan dan restrukturisasi perusahaan keluar masuknya pesero, susunan pengurus baru ditetapkan untuk membawa CV Berkah Hidayatullah menuju babak yang lebih profesional dan skalabel.",
      direktur: "Direktur",
      komanditer: "Pesero Komanditer",
      modal: {
        title: "Total Modal Dasar",
        value: "100%",
        desc: "Disetor penuh ke kas perseroan dengan porsi kepemilikan saham sebagai berikut:",
        porsi1: "Porsi Efendi Payuyu:",
        porsi2: "Porsi Darwin Djafar:",
        val1: "75%",
        val2: "25%"
      }
    },
    sidebar: {
      title: "Maksud & Tujuan (KBLI)",
      desc: "Perusahaan telah memperluas sayap operasi melalui pendaftaran KBLI untuk klasifikasi pekerjaan, mencakup:",
      items: [
  ...
  footer: {
    desc: "Mitra terpercaya untuk proyek konstruksi, perdagangan umum, agribisnis, hingga pengadaan jasa berkualitas tinggi di Gorontalo.",
    contactTitle: "Hubungi Kami",
    legalTitle: "Informasi Legal",
    address: "Desa Ombulo, Kecamatan Limboto Barat,<br />Kabupaten Gorontalo.",
    rights: "All rights reserved.",
    legitimacy: "Legitimasi Hukum"
  }
};
